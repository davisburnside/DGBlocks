...
def _ui_draw_textbox_3d_controls(context, container, debug_props):
    """3D mode: the independent X/Y anchor, then the 3D point sliders."""
    container.prop(debug_props, "textbox_anchor_x")
    container.prop(debug_props, "textbox_anchor_y")

    point_row = container.row(align=True)
    point_row.prop(debug_props, "textbox_3d_x")
    point_row.prop(debug_props, "textbox_3d_y")
    point_row.prop(debug_props, "textbox_3d_z")
...
def _ui_draw_textbox_body(context, container):
    ...
    container.prop(debug_props, "textbox_draw_mode")

    if debug_props.textbox_draw_mode == "2D":
        ...
        _ui_draw_textbox_3d_controls(context, container, debug_props)
