...
class Animation_Declaration:
    ...
    Wrapper_Animation_Manager.add_animations() or .set_animation().

    Fields
    ------
    animation_uid       Unique string identifier.  Must not already be active when passed
                        to add_animations(); set_animation() upserts instead.
    ...
    loop_mode           ANIM_LOOP_ONCE (default), ANIM_LOOP_REPEAT or ANIM_LOOP_PING_PONG.
                        ...
                        is exhausted; remove them with cancel_animation().
...
class Animation_Instance:
    ...
    # Private — set after construction by Wrapper_Animation_Manager
